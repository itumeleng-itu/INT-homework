<%-- 
    Document   : sec
    Created on : 11 May 2025, 3:20:43 PM
    Author     : matom
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            :root {
                ...
                --accent-color: #34a853; /* Green for security */
                --light-color: #f8f9fa;
                --dark-color: #202124;
    ...
    <body>
        <div class="container">
            ...
            <p>Thank you for keeping our institution safe and secure</p>
            <p>As security personnel, you can verify student identity</p>

            <div class="security-section">
                <h3 class="section-title">Verify Student Identity</h3>
                <form action="searchStudentServlet.do" method="post">
                    <table>
                        ...
                        <tr>
                            <td><input type="submit" value="VERIFY STUDENT"/></td>
                        </tr>
                    </table>
                </form>
            </div>
